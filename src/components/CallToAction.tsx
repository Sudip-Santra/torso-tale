  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 text-center text-white relative z-10">
        <div className="max-w-3xl mx-auto bg-black/30 backdrop-blur-sm p-8 md:p-12 rounded-lg border border-white/10 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#"
              className="group relative bg-saree-teal hover:bg-saree-deep-teal text-white font-medium px-8 py-3 rounded-md transition-all duration-300 shadow-md hover:shadow-lg overflow-hidden"
            >
            ...
            <a
              href="#"
              className="group relative bg-transparent hover:bg-white/20 text-white border border-white/50 font-medium px-8 py-3 rounded-md transition-all duration-300 overflow-hidden"
            >
